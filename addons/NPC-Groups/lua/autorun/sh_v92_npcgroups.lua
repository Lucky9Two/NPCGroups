...
if not ConVarExists( "vnt_debug_prints" ) then CreateClientConVar( "vnt_debug_prints" , '0' , true , false ) end

if not ConVarExists( "npcg_randomyaw" ) then CreateConVar( "npcg_randomyaw" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_spawner_wavetime" ) then CreateConVar( "npcg_spawner_wavetime" , "10" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_longvision" ) then CreateConVar( "npcg_longvision" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_weapondrop" ) then CreateConVar( "npcg_weapondrop" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_pickupguns" ) then CreateConVar( "npcg_pickupguns" , "0" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_alyx_alyxgun" ) then CreateConVar( "npcg_alyx_alyxgun" , "0" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_manhackcount" ) then CreateConVar( "npcg_manhackcount" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_grenadecount" ) then CreateConVar( "npcg_grenadecount" , "5" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_patrol_toggle" ) then CreateConVar( "npcg_patrol_toggle" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_ignorepushing" ) then CreateConVar( "npcg_ignorepushing" , "0" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_random_rebels" ) then CreateConVar( "npcg_random_rebels" , "0" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_vortchargearmor" ) then CreateConVar( "npcg_vortchargearmor" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_regenhealth_ally" ) then CreateConVar( "npcg_regenhealth_ally" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_regenhealth_vort" ) then CreateConVar( "npcg_regenhealth_vort" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_rollermineburied" ) then CreateConVar( "npcg_rollermineburied" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
...
if not ConVarExists( "npcg_squaddies_vort" ) then CreateConVar( "npcg_squaddies_vort" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_squaddies_zmbs" ) then CreateConVar( "npcg_squaddies_zmbs" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_squaddies_hunter" ) then CreateConVar( "npcg_squaddies_hunter" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_squaddies_worker" ) then CreateConVar( "npcg_squaddies_worker" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
...
--	Dice
if not ConVarExists( "npcg_medicchance" ) then CreateConVar( "npcg_medicchance" , "16" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_zombietorsochance" ) then CreateConVar( "npcg_zombietorsochance" , "4" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_rebelresupplychance" ) then CreateConVar( "npcg_rebelresupplychance" , "16" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
--	Wake Radii
if not ConVarExists( "npcg_wakeradius_cp" ) then CreateConVar( "npcg_wakeradius_cp" , "200" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_wakeradius_dog" ) then CreateConVar( "npcg_wakeradius_dog" , "500" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_wakeradius_cmb" ) then CreateConVar( "npcg_wakeradius_cmb" , "200" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_wakeradius_zmb" ) then CreateConVar( "npcg_wakeradius_zmb" , "100" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_wakeradius_vort" ) then CreateConVar( "npcg_wakeradius_vort" , "500" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_wakeradius_human" ) then CreateConVar( "npcg_wakeradius_human" , "150" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_wakeradius_scanner" ) then CreateConVar( "npcg_wakeradius_scanner" , "300" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
--	Squad Toggles
if not ConVarExists( "npcg_squad_human" ) then CreateConVar( "npcg_squad_human" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_squad_zombie" ) then CreateConVar( "npcg_squad_zombie" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
...
--	Accuracy
if not ConVarExists( "npcg_accuracy_cp" ) then CreateConVar( "npcg_accuracy_cp" , "2" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_accuracy_alyx" ) then CreateConVar( "npcg_accuracy_alyx" , "4" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_accuracy_monk" ) then CreateConVar( "npcg_accuracy_monk" , "4" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_accuracy_rebel" ) then CreateConVar( "npcg_accuracy_rebel" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_accuracy_barney" ) then CreateConVar( "npcg_accuracy_barney" , "4" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_accuracy_citizen" ) then CreateConVar( "npcg_accuracy_citizen" , "0" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_accuracy_combine" ) then CreateConVar( "npcg_accuracy_combine" , "4" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
--	Zombify Toggles
-- if not ConVarExists( "npcg_zombify_npc" ) then CreateConVar( "npcg_zombify_npc" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
-- if not ConVarExists( "npcg_zombify_ply" ) then CreateConVar( "npcg_zombify_ply" , "1" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
--	Customizable squads
if not ConVarExists( "npcg_custom_model_cp" ) then CreateConVar( "npcg_custom_model_cp" , "models/police.mdl" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
...
if not ConVarExists( "npcg_custom_model_rebel" ) then CreateConVar( "npcg_custom_model_rebel" , "models/humans/group03/male_09.mdl" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_custom_model_combine" ) then CreateConVar( "npcg_custom_model_combine" , "models/combine_soldier_prisonguard.mdl" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
...
-- local function npcgPLYZombification( vic , atk , kil ) 
	-- if GetConVarNumber( "npcg_zombify_ply" ) != 0 then
		...
		-- local ClassZombiePoison = "npc_poisonzombie"
		-- local NPC = nil
		-- if Victim:IsPlayer( ) and table.HasValue( HeadcrabTable , KillerClass ) then
			-- if KillerClass == ClassHeadcrab then
...
list.Set( "NPC" , "npcgs_uriah" , { ["Name"] = "Uriah" , ["Class"] = "npcgs_uriah" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_uriah_hostile" , { ["Name"] = "Hostile Uriah" , ["Class"] = "npcgs_uriah_hostile" , ["Category"] = Category } ) 
...
list.Set( "NPC" , "npcgs_cstm_civilian" , { ["Name"] = "Custom Citizen" , ["Class"] = "npcgs_cstm_civilian" , ["Category"] = Category } ) 

list.Set( "NPC" , "npcg_cstm_civilian" , { ["Name"] = "Custom Citizens" , ["Class"] = "npcg_cstm_civilian" , ["Category"] = Category } ) 
...
list.Set( "NPC" , "npcg_reb_white" , { ["Name"] = "White Forest" , ["Class"] = "npcg_reb_white" , ["Category"] = Category } ) 
...
list.Set( "NPC" , "npcg_rebft_hostile" , { ["Name"] = "Hostile Rebel Fireteam" , ["Class"] = "npcg_rebft_hostile" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcg_rebft_coward" , { ["Name"] = "Cowardly Rebel Fireteam" , ["Class"] = "npcg_rebft_coward" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcg_rebsqd" , { ["Name"] = "Rebel Squad" , ["Class"] = "npcg_rebsqd" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcg_rebsqd_hostile" , { ["Name"] = "Hostile Rebel Squad" , ["Class"] = "npcg_rebsqd_hostile" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcg_partisan" , { ["Name"] = "Partisan Cell" , ["Class"] = "npcg_partisan" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcg_partisan_hostile" , { ["Name"] = "Hostile Partisan Cell" , ["Class"] = "npcg_partisan_hostile" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcg_partisan_coward" , { ["Name"] = "Cowardly Partisan Cell" , ["Class"] = "npcg_partisan_coward" , ["Category"] = Category } ) 
-------------------------------------------------------
-------------------------------------------------------
-------------------------------------------------------
-------------------------------------------------------
...
list.Set( "NPC" , "npcgs_cmbsoldier_friendly" , { ["Name"] = "Friendly Soldier" , ["Class"] = "npcgs_cmbsoldier_friendly" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbshotgun" , { ["Name"] = "Shotgunner" , ["Class"] = "npcgs_cmbshotgun" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbshotgun_friendly" , { ["Name"] = "Friendly Shotgunner" , ["Class"] = "npcgs_cmbshotgun_friendly" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbelite" , { ["Name"] = "Elite" , ["Class"] = "npcgs_cmbelite" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbelite_friendly" , { ["Name"] = "Friendly Elite" , ["Class"] = "npcgs_cmbelite_friendly" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbnpguard" , { ["Name"] = "Prison Soldier" , ["Class"] = "npcgs_cmbnpguard" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbnpguard_friendly" , { ["Name"] = "Friendly Prison Soldier" , ["Class"] = "npcgs_cmbnpguard_friendly" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbnpsgguard" , { ["Name"] = "Prison Shotgunner" , ["Class"] = "npcgs_cmbnpsgguard" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbnpsgguard_friendly" , { ["Name"] = "Friendly Prison Shotgunner" , ["Class"] = "npcgs_cmbnpsgguard_friendly" , ["Category"] = Category } ) 
...
list.Set( "NPC" , "npcg_cpft_neutral" , { ["Name"] = "Neutral CP Fireteam" , ["Class"] = "npcg_cpft_neutral" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcg_cmbft" , { ["Name"] = "Combine Fireteam" , ["Class"] = "npcg_cmbft" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcg_cmbft_neutral" , { ["Name"] = "Neutral Combine Fireteam" , ["Class"] = "npcg_cmbft_neutral" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcg_cmbft_coward" , { ["Name"] = "Cowardly Combine Fireteam" , ["Class"] = "npcg_cmbft_coward" , ["Category"] = Category } ) 
...
list.Set( "NPC" , "npcgs_cmbsoldier_friendly_spawn" , { ["Name"] = "Friendly Soldier" , ["Class"] = "npcgs_cmbsoldier_friendly_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbshotgun_spawn" , { ["Name"] = "Shotgunner" , ["Class"] = "npcgs_cmbshotgun_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbshotgun_friendly_spawn" , { ["Name"] = "Friendly Shotgunner" , ["Class"] = "npcgs_cmbshotgun_friendly_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbelite_spawn" , { ["Name"] = "Elite" , ["Class"] = "npcgs_cmbelite_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbelite_friendly_spawn" , { ["Name"] = "Friendly Elite" , ["Class"] = "npcgs_cmbelite_friendly_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbnpguard_spawn" , { ["Name"] = "Prison Soldier" , ["Class"] = "npcgs_cmbnpguard_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbnpguard_friendly_spawn" , { ["Name"] = "Friendly Prison Soldier" , ["Class"] = "npcgs_cmbnpguard_friendly_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbnpsgguard_spawn" , { ["Name"] = "Prison Shotgunner" , ["Class"] = "npcgs_cmbnpsgguard_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_cmbnpsgguard_friendly_spawn" , { ["Name"] = "Friendly Prison Shotgunner" , ["Class"] = "npcgs_cmbnpsgguard_friendly_spawn" , ["Category"] = Category } ) 
...
list.Set( "NPC" , "npcgs_rebel_hostile_spawn" , { ["Name"] = "Hostile Rebel" , ["Class"] = "npcgs_rebel_hostile_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_rebel_medic_spawn" , { ["Name"] = "Medic" , ["Class"] = "npcgs_rebel_medic_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_rebel_medic_hostile_spawn" , { ["Name"] = "Hostile Medic" , ["Class"] = "npcgs_rebel_medic_hostile_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_rebel_rkt_spawn" , { ["Name"] = "Rocketeer" , ["Class"] = "npcgs_rebel_rkt_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcgs_rebel_rkt_hostile_spawn" , { ["Name"] = "Hostile Rocketeer" , ["Class"] = "npcgs_rebel_rkt_hostile_spawn" , ["Category"] = Category } ) 
...
list.Set( "NPC" , "npcgs_cstm_civilian_spawn" , { ["Name"] = "Custom Citizen" , ["Class"] = "npcgs_cstm_civilian_spawn" , ["Category"] = Category } ) 
...
list.Set( "NPC" , "npcg_rebsqd_spawn" , { ["Name"] = "Rebel Squad" , ["Class"] = "npcg_rebsqd_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcg_rebsqd_hostile_spawn" , { ["Name"] = "Hostile Rebel Squad" , ["Class"] = "npcg_rebsqd_hostile_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcg_rebft_hostile_spawn" , { ["Name"] = "Hostile Rebel Fireteam" , ["Class"] = "npcg_rebft_hostile_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcg_rebft_neutral_spawn" , { ["Name"] = "Neutral Rebel Fireteam" , ["Class"] = "npcg_rebft_neutral_spawn" , ["Category"] = Category } ) 
...
list.Set( "NPC" , "npcg_cmbft_neutral_spawn" , { ["Name"] = "Neutral Combine Fireteam" , ["Class"] = "npcg_cmbft_neutral_spawn" , ["Category"] = Category } ) 
...
list.Set( "NPC" , "npcg_partisan_hostile_spawn" , { ["Name"] = "Hostile Partisan Fireteam" , ["Class"] = "npcg_partisan_hostile_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcg_hunterpack_spawn" , { ["Name"] = "Hunter Pack" , ["Class"] = "npcg_hunterpack_spawn" , ["Category"] = Category } ) 
list.Set( "NPC" , "npcg_hunterpack_friendly_spawn" , { ["Name"] = "Friendly Hunter Pack" , ["Class"] = "npcg_hunterpack_friendly_spawn" , ["Category"] = Category } ) 
...
list.Set( "NPC" , "npcg_cpft_neutral_spawn" , { ["Name"] = "Neutral CP Fireteam" , ["Class"] = "npcg_cpft_neutral_spawn" , ["Category"] = Category } ) 
...
list.Set( "NPC" , "npcg_cstm_civilian_spawn" , { ["Name"] = "Custom Citizens" , ["Class"] = "npcg_cstm_civilian_spawn" , ["Category"] = Category } ) 
