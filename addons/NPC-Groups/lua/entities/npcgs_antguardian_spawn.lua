...
ENT.Type 			= "anim"
ENT.Base 			= "base_anim"
ENT.PrintName		= "Antlion Guardian Spawner"
...
if SERVER then
	...
	function ENT:Initialize()
		...
		self.ent1:SetMaterial( "models/antlion_guard/antlionguard2" )
	...
	/*		
		self.ent1:AddRelationship("player D_HT 20")
		self.ent2:AddRelationship("npc_antlionguard D_FR 200")
		self.ent3:AddRelationship("npc_antlionguard D_FR 200")
		self.ent4:AddRelationship("npc_antlionguard D_FR 200")
		self.ent5:AddRelationship("npc_antlionguard D_FR 200")
	*/	
