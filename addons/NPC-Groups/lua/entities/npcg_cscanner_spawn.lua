...
ENT.Type = "anim"
ENT.Base = "base_anim"
ENT.PrintName = "City Scanner Spawner"
ENT.Author = "V92"
ENT.Information = ""
...
if SERVER then
	function ENT:Initialize( )
		...
		self.ent3 = ents.Create( "npc_cscanner" )
		...
		self.ent4 = ents.Create( "npc_cscanner" )
		...
		if GetConVarNumber( "npcg_healthvariant_scanner" ) > 1 then
			self.ent1:SetHealth( GetConVarNumber( "npcg_healthoverride_civ" ) )
			self.ent2:SetHealth( GetConVarNumber( "npcg_healthoverride_civ" ) )
			self.ent3:SetHealth( GetConVarNumber( "npcg_healthoverride_civ" ) )
			self.ent4:SetHealth( GetConVarNumber( "npcg_healthoverride_civ" ) )
		elseif GetConVarNumber( "npcg_healthvariant_scanner" ) == 1 then
			self.ent1:SetHealth( math.random( 20 , 50 ) )
			self.ent2:SetHealth( math.random( 20 , 50 ) )
			self.ent3:SetHealth( math.random( 20 , 50 ) )
			self.ent4:SetHealth( math.random( 20 , 50 ) )
		end
	...
	function ENT:Think( )
		...
		if !self.ent1:IsValid( ) then
			self.ent1 = ents.Create( "npc_cscanner" )
			self.ent1:SetPos( self:GetPos( ) + self:GetUp( ) * 50 )
			self.ent1:SetHealth( GetConVarNumber( "npcg_healthoverride_scanner" ) )
			self.ent1:SetKeyValue( "wakeradius" , GetConVarNumber( "npcg_wakeradius_scanner" ) )
			self.ent1:SetKeyValue( "spawnflags" , tostring( self.kvNum + self.longNum + self.pushNum + self.fadeNum ) )
			self.ent1:Spawn( )
			self.ent1:Activate( )
		...
		if !self.ent2:IsValid( ) then
			self.ent2 = ents.Create( "npc_cscanner" )
			self.ent2:SetPos( self:GetPos( ) + self:GetForward( ) * 50 + self:GetRight( ) * 50 + self:GetUp( ) * 50 )
			self.ent2:SetHealth( GetConVarNumber( "npcg_healthoverride_scanner" ) )
			self.ent2:SetKeyValue( "wakeradius" , GetConVarNumber( "npcg_wakeradius_scanner" ) )
			self.ent2:SetKeyValue( "spawnflags" , tostring( self.kvNum + self.longNum + self.pushNum + self.fadeNum ) )
			self.ent2:Spawn( )
			self.ent2:Activate( )
		...
		if !self.ent3:IsValid( ) then
			self.ent3 = ents.Create( "npc_cscanner" )
			self.ent3:SetPos( self:GetPos( ) + self:GetForward( ) * 50 + self:GetRight( ) * -50 + self:GetUp( ) * 50 )
			self.ent3:SetHealth( GetConVarNumber( "npcg_healthoverride_scanner" ) )
			self.ent3:SetKeyValue( "wakeradius" , GetConVarNumber( "npcg_wakeradius_scanner" ) )
			self.ent3:SetKeyValue( "spawnflags" , tostring( self.kvNum + self.longNum + self.pushNum + self.fadeNum ) )
			self.ent3:Spawn( )
			self.ent3:Activate( )
