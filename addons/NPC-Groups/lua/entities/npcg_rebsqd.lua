...
if SERVER then
	...
	function ENT:Initialize( )
		...
		if IsMounted( "ep2" ) and GetConVarNumber( "npcg_squaddies_vort" ) != 0 then
			...
			if self.randomModel == 0 then self.ent5:SetModel( "models/humans/group03/male_09.mdl" ) end
		...
		if self.randomModel == 0 then self.ent8:SetModel( "models/humans/group03/male_01.mdl" ) end
		self.ent8:SetKeyValue( "DontPickupWeapons" , GetConVarNumber( "npcg_pickupguns" ) )
		self.ent8:SetKeyValue( "additionalequipment" , table.Random( WeaponTblTwo ) )
