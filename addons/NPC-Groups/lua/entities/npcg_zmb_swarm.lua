...
if SERVER then
	...
	function ENT:Initialize( )
		...
		self.ent4 = ents.Create( "npc_zombie" )
		...
		self.ent6 = ents.Create( "npc_zombie" )
		...
		self.ent7 = ents.Create( "npc_zombie" )
		...
		self.ent8 = ents.Create( "npc_zombie" )
		...
		self.ent9 = ents.Create( "npc_fastzombie" )
		self.ent9:SetPos( self:GetPos( ) + self:GetForward( ) * 200 + self:GetRight( ) * -100 )
		self.ent9:SetKeyValue( "spawnflags" , tostring( self.kvNum + self.longNum + self.pushNum + self.fadeNum ) )
		self.ent9:SetKeyValue( "wakeradius" , GetConVarNumber( "npcg_wakeradius_zmb" ) )
		self.ent9:Spawn( )
		self.ent9:Activate( )
		self.ent9:SetSchedule( SCHED_IDLE_WANDER )

		self.ent10 = ents.Create( "npc_poisonzombie" )
		self.ent10:SetPos( self:GetPos( ) + self:GetRight( ) * 100 )
		self.ent10:SetKeyValue(	"crabcount" , math.random( 1 , 3 ) )
		self.ent10:SetKeyValue( "spawnflags" , tostring( self.kvNum + self.longNum + self.pushNum + self.fadeNum ) )
		self.ent10:SetKeyValue( "wakeradius" , GetConVarNumber( "npcg_wakeradius_zmb" ) )
		self.ent10:Spawn( )
		self.ent10:Activate( )
		...
		if IsMounted( "ep2" ) and GetConVarNumber( "npcg_squaddies_zmbs" ) != 0 then
			...
			self.ent11:SetKeyValue( "wakeradius" , GetConVarNumber( "npcg_wakeradius_zmb" ) )
			self.ent11:Spawn( )
			self.ent11:Activate( )
		...
		if GetConVarNumber( "npcg_squad_zombie" ) != 0 then
			...
			self.ent5:SetKeyValue( "SquadName" , "Zombie" )
			self.ent6:SetKeyValue( "SquadName" , "Zombie" )
			self.ent7:SetKeyValue( "SquadName" , "Zombie" )
			self.ent8:SetKeyValue( "SquadName" , "Zombie" )
