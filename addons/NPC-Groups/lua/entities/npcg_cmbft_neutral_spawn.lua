...
ENT.Type 			= "anim"
ENT.Base 			= "base_anim"
ENT.PrintName		= "Neutral Combine Fireteam Spawner"
...
if SERVER then
	function ENT:Initialize()
		...
		self.ent1:AddRelationship("*npc_combine* D_NU 200")
		...
		self.ent2:AddRelationship("*npc_combine* D_NU 200")
		...
		self.ent3:AddRelationship("*npc_combine* D_NU 200")
		...
		self.ent4:AddRelationship("*npc_combine* D_NU 200")
		...
		self.ent5:AddRelationship("*npc_combine* D_NU 200")
