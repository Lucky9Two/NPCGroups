...
if SERVER then
	...
	function ENT:Initialize( ) 
		...
		self.ent1:SetKeyValue( "citizentype" , math.random( 2,3 ) ) 
		if self.randomModel == 0 then self.ent1:SetModel( "models/humans/group03/male_06.mdl" ) end
		self.ent1:SetKeyValue( "DontPickupWeapons" , GetConVarNumber( "npcg_pickupguns" ) ) 
		self.ent1:SetKeyValue( "additionalequipment" , table.Random( WeaponTbl ) ) 
		self.ent1:SetKeyValue( "Expression Type" , "Random" ) 
		self.ent1:SetKeyValue( "spawnflags" , tostring( self.kvNum + self.longNum + self.weaponNum + self.pushNum + self.fadeNum + self.resupplyChance + self.medicChance ) ) 
		...
		self.ent5:SetPos( self:GetPos( ) + self:GetForward( ) * 0 + self:GetRight( ) * 50 ) 
		self.ent5:SetKeyValue( "citizentype" , math.random( 2,3 ) ) 
		if self.randomModel == 0 then self.ent5:SetModel( "models/humans/group03/male_01.mdl" ) end
		self.ent5:SetKeyValue( "DontPickupWeapons" , GetConVarNumber( "npcg_pickupguns" ) ) 
		self.ent5:SetKeyValue( "additionalequipment" , table.Random( WeaponTblTwo ) ) 
		...
		self.ent6 = ents.Create( "npc_citizen" ) 
		self.ent6:SetPos( self:GetPos( ) + self:GetForward( ) * -50 + self:GetRight( ) * 0 ) 
		self.ent6:SetKeyValue( "citizentype" , math.random( 2,3 ) ) 
		if self.randomModel == 0 then self.ent6:SetModel( "models/humans/group03/male_08.mdl" ) end
		self.ent6:SetKeyValue( "DontPickupWeapons" , GetConVarNumber( "npcg_pickupguns" ) ) 
		self.ent6:SetKeyValue( "additionalequipment" , table.Random( WeaponTblTwo ) ) 
		self.ent6:SetKeyValue( "Expression Type" , "Random" ) 
		self.ent6:SetKeyValue( "spawnflags" , tostring( self.kvNum + self.longNum + self.weaponNum + self.pushNum + self.fadeNum + self.resupplyChance + self.medicChance ) ) 
		self.ent6:SetKeyValue( "wakeradius" , GetConVarNumber( "npcg_wakeradius_human" ) ) 
		self.ent6:Spawn( ) 
		self.ent6:Activate( ) 
		self.ent6:SetSchedule( SCHED_IDLE_WANDER ) 

		self.ent7 = ents.Create( "npc_citizen" ) 
		self.ent7:SetPos( self:GetPos( ) + self:GetForward( ) * 50 + self:GetRight( ) * 0 ) 
		self.ent7:SetKeyValue( "citizentype" , math.random( 2,3 ) ) 
		if self.randomModel == 0 then self.ent7:SetModel( "models/humans/group03/female_03.mdl" ) end
		self.ent7:SetKeyValue( "DontPickupWeapons" , GetConVarNumber( "npcg_pickupguns" ) ) 
		self.ent7:SetKeyValue( "additionalequipment" , table.Random( WeaponTbl ) ) 
		self.ent7:SetKeyValue( "Expression Type" , "Random" ) 
		self.ent7:SetKeyValue( "spawnflags" , tostring( self.kvNum + self.longNum + self.weaponNum + self.pushNum + self.fadeNum + self.resupplyChance + self.medicChance ) ) 
		self.ent7:SetKeyValue( "wakeradius" , GetConVarNumber( "npcg_wakeradius_human" ) ) 
		self.ent7:Spawn( ) 
		self.ent7:Activate( ) 
		...
		if IsMounted( "ep2" ) and GetConVarNumber( "npcg_squaddies_vort" ) != 0 then
			...
			self.ent8 = ents.Create( "npc_vortigaunt" ) 
			self.ent8:SetPos( self:GetPos( ) + self:GetForward( ) * 50 + self:GetRight( ) * -50 ) 

			if GetConVarNumber( "npcg_squad_vort" ) != 0 then self.ent8:SetKeyValue( "SquadName" , "Human" ) end
			...
			if GetConVarNumber( "npcg_regenhealth_vort" ) != 0 then 
				self.ent8:SetKeyValue( "HealthRegenerateEnabled" , 1 ) 
		end

			self.ent8:SetKeyValue( "spawnflags" , tostring( self.kvNum + self.longNum + self.pushNum + self.fadeNum ) ) 
			self.ent8:SetKeyValue( "wakeradius" , GetConVarNumber( "npcg_wakeradius_vort" ) ) 
			self.ent8:Spawn( ) 
			self.ent8:Activate( ) 
			...
			self.ent8 = ents.Create( "npc_citizen" ) 
			self.ent8:SetPos( self:GetPos( ) + self:GetForward( ) * 50 + self:GetRight( ) * -50 ) 
			self.ent8:SetKeyValue( "citizentype" , math.random( 2,3 ) ) 
			if self.randomModel == 0 then self.ent8:SetModel( "models/humans/group03/male_09.mdl" ) end
			if GetConVarNumber( "npcg_squad_human" ) != 0 then self.ent8:SetKeyValue( "SquadName" , "Human" ) end
			...
			self.ent8:SetKeyValue( "DontPickupWeapons" , GetConVarNumber( "npcg_pickupguns" ) ) 
			self.ent8:SetKeyValue( "additionalequipment" , table.Random( WeaponTbl ) ) 
			self.ent8:SetKeyValue( "Expression Type" , "Random" ) 
			self.ent8:SetKeyValue( "spawnflags" , tostring( self.kvNum + self.longNum + self.weaponNum + self.pushNum + self.fadeNum + self.resupplyChance + self.medicChance ) ) 
			self.ent8:SetKeyValue( "wakeradius" , GetConVarNumber( "npcg_wakeradius_human" ) ) 
			self.ent8:Spawn( ) 
			self.ent8:Activate( ) 
			self.ent8:SetSchedule( SCHED_IDLE_WANDER )
		...
		if GetConVarNumber( "npcg_squad_human" ) != 0 then
			...
			self.ent6:SetKeyValue( "SquadName" , "Human" ) 
			self.ent7:SetKeyValue( "SquadName" , "Human" ) 
			self.ent8:SetKeyValue( "SquadName" , "Human" )
		...
		self.ent6:AddRelationship( "player D_HT 200" ) 
		self.ent7:AddRelationship( "player D_HT 200" ) 
		self.ent8:AddRelationship( "player D_HT 200" ) 
	...
	function ENT:OnRemove( ) 
		...
		if self.ent6 then self.ent6:Remove( ) end
		if self.ent7 then self.ent7:Remove( ) end
		if self.ent8 then self.ent8:Remove( ) end
