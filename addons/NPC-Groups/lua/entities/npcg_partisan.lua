...
if SERVER then
	function ENT:Initialize( )
		...
		self.ent2:SetKeyValue( "citizentype" , math.random( 0,2 ) )
		if self.randomModel == 0 then self.ent2:SetModel( "models/humans/group01/male_02.mdl" ) end
