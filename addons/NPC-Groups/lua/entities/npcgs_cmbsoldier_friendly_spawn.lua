...
if not ConVarExists( "npcg_healthoverride_cmb" ) then CreateConVar(	"npcg_healthoverride_cmb" ,  		"150" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_healthoverride_cmbnp" ) then CreateConVar(	"npcg_healthoverride_cmbnp" , 		"150" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_healthvariant_cmb" ) then CreateConVar(	"npcg_healthvariant_cmb" ,  		"0" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end
if not ConVarExists( "npcg_healthvariant_cmbnp" ) then CreateConVar(	"npcg_healthvariant_cmbnp" ,  		"0" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end

ENT.Type = "anim"
ENT.Base = "base_anim"
ENT.PrintName = "Friendly Combine Soldier Spawner"
ENT.Author = "V92"
ENT.Information = ""
...
if SERVER then
	...
	function ENT:Initialize( )
		...
		self.ent1:SetKeyValue( "FriendlyToHumans" , 1 )
