...
if SERVER then
	...
	function ENT:Initialize( )
		...
		self.ent1:SetHealth( GetConVarNumber( "npcg_healthoverride_manhack" ) )
		...
		self.ent2:SetHealth( GetConVarNumber( "npcg_healthoverride_manhack" ) )
		...
		self.ent3:SetHealth( GetConVarNumber( "npcg_healthoverride_manhack" ) )
		...
		self.ent4:SetHealth( GetConVarNumber( "npcg_healthoverride_manhack" ) )
