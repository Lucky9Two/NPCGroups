...
if SERVER then
	function ENT:Initialize()
		...
		self.ent1 = ents.Create("npc_seagull")
		...
		self.ent1:SetKeyValue( "wakeradius", GetConVarNumber( "npcg_wakeradius_bird" ) )
		self.ent1:Spawn()
		self.ent1:Activate()
		self.ent1:SetSchedule( SCHED_IDLE_WANDER )
		
		self.ent2 = ents.Create("npc_seagull")
		...
		self.ent2:SetKeyValue( "wakeradius", GetConVarNumber( "npcg_wakeradius_bird" ) )
		self.ent2:Spawn()
		self.ent2:Activate()
		self.ent2:SetSchedule( SCHED_IDLE_WANDER )
		
		self.ent3 = ents.Create("npc_seagull")
		...
		self.ent3:SetKeyValue( "wakeradius", GetConVarNumber( "npcg_wakeradius_bird" ) )
		self.ent3:Spawn()
		self.ent3:Activate()
		self.ent3:SetSchedule( SCHED_IDLE_WANDER )
		
		self.ent4 = ents.Create("npc_seagull")
		...
		self.ent4:SetKeyValue( "wakeradius", GetConVarNumber( "npcg_wakeradius_bird" ) )
		self.ent4:Spawn()
		self.ent4:Activate()
		...
		if GetConVarNumber( "npcg_squad_bird" ) != 0	then
			...
			self.ent2:SetKeyValue( "SquadName", "BirdSquad" )
			self.ent3:SetKeyValue( "SquadName", "BirdSquad" )
			self.ent4:SetKeyValue( "SquadName", "BirdSquad" )
		end
