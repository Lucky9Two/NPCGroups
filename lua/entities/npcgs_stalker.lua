...
if !ConVarExists( "VNT_Debug_Prints" ) then CreateConVar(	"npcg_healthoverride_cmbstk", 		"50",		{	FCVAR_REPLICATED, FCVAR_ARCHIVE }	) end
if !ConVarExists( "VNT_Debug_Prints" ) then CreateConVar(	"npcg_healthvariant_cmbstk",	 	"0",		{	FCVAR_REPLICATED, FCVAR_ARCHIVE }	) end
...
if SERVER then
	function ENT:Initialize()
		...
		if GetConVarNumber( "npcg_squad_stalker" ) != 0	then
			self.ent1:SetKeyValue( "SquadName", "CmbStalkerSquad" )
		end
