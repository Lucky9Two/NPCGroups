...
local	_WEPTwo	=	{ "weapon_rpg" , "weapon_ar2" }
...
if SERVER then
	function ENT:Initialize()
		...
		self.ent6:SetKeyValue( "additionalequipment", table.Random( _WEPTwo ) )
		...
		self.ent8:SetKeyValue( "additionalequipment", table.Random( _WEPTwo ) )
